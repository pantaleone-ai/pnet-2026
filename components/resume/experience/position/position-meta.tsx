...
export default function PositionMeta({
  ...
  return (
    <div className="mx-auto flex w-full flex-col divide-y divide-border-edge border border-border-edge text-center md:mx-0 md:flex-row md:divide-x md:divide-y-0 md:text-left">
