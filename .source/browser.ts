...
const browserCollections = {
  ...
  featuredApps: create.doc("featuredApps", {"ai-saas-starter-nextjs-betterauth-supabase-free-boilerplate.mdx": () => import("../features/home/content/featured-apps/ai-saas-starter-nextjs-betterauth-supabase-free-boilerplate.mdx?collection=featuredApps"), "imgsquash.mdx": () => import("../features/home/content/featured-apps/imgsquash.mdx?collection=featuredApps"), "migratecms-migrate-anycms-to-nextjs.mdx": () => import("../features/home/content/featured-apps/migratecms-migrate-anycms-to-nextjs.mdx?collection=featuredApps"), }),
